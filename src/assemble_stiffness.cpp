    ...
    for(int i = 0; i < F.rows(); i++)
    {
        ...
        for(int ii = 0; ii < 3; ii++)
        {
            for (int jj = 0; jj < 3; jj++)
            {
                ...
                //tripleList.push_back(Trip(3*F(i, 0)+ii, 3*F(i, 3)+jj, -H_i03.coeff(ii, jj)));
                ...
                //tripleList.push_back(Trip(3*F(i, 1)+ii, 3*F(i, 3)+jj, -H_i13.coeff(ii, jj)));
                ...
                //tripleList.push_back(Trip(3*F(i, 2)+ii, 3*F(i, 3)+jj, -H_i23.coeff(ii, jj)));
